...
require_once 'class_product_collection.php';
...
echo $productCollection->getAllProductPrice() . "<br>";
echo $productCollection->getCountCollection() . "<br>";
                    ...
                    <div class="product-carousel">
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-carousel-price">
                                <ins>$<?= $product->getDiscountPrice() ?></ins> <del>$<?= $product->getOriginalPrice()?></del>
                            </div>
                        </div>
                        <?php endforeach; ?>
                        <div class="single-product">
